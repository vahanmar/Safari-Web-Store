(() => {
    ...
    da.init();
    const clearButton = document.querySelector(".size-option__clear");
    const clearValues = document.querySelectorAll(".size-option__value");
    clearValues.forEach((clearValue => {
        clearValue.addEventListener("click", (function(e) {
            clearValue.classList.toggle("active");
        }));
    }));
    if (clearButton) clearButton.addEventListener("click", (function(e) {
        clearValues.forEach((clearValue => {
            if (clearValue.classList.contains("active")) clearValue.classList.remove("active");
        }));
    }));
    const clearColor = document.querySelector(".color-option__clear");
    const clearShades = document.querySelectorAll(".color-option__img");
    clearShades.forEach((clearShade => {
        clearShade.addEventListener("click", (function(e) {
            clearShade.classList.toggle("active");
        }));
    }));
    if (clearColor) clearColor.addEventListener("click", (function(e) {
        clearShades.forEach((clearShade => {
            if (clearShade.classList.contains("active")) clearShade.classList.remove("active");
        }));
    }));
    const clearPrice = document.querySelector(".price-option__clear");
    const clearLevels = document.querySelectorAll(".price-option__level input");
    const clearInputs = document.querySelectorAll(".price-option__input");
    if (clearPrice) clearPrice.addEventListener("click", (function(e) {
        clearLevels.forEach((clearLevel => {
            clearLevel.checked = false;
        }));
